...
import com.qualcomm.internal.telephony.MSimUiccCard;
...
public class StkAppService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        if((msg.arg1!=OP_CARD_STATE_CHANGED)&&(msg.arg1!=OP_RESPONSE)){
    ...
    private void handleCmd(CatCmdMessage cmdMsg) {
        ...
        case DISPLAY_TEXT:
            ...
            responseNeeded = waitForUsersResponse = msg.responseNeeded;
